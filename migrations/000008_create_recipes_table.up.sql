CREATE TABLE recipes (
    ...
    CONSTRAINT fk_recipes_material_uom_id FOREIGN KEY (material_uom_id) REFERENCES material_uoms(id) ON DELETE RESTRICT,
...
COMMENT ON COLUMN recipes.material_uom_id IS 'Unit used in this recipe, references material_uoms for conversion multiplier';
